...
setwd("/Users/olangoea/Library/CloudStorage/OneDrive-KAUST/Documents/PNG/r_results/")
pdf("Mainshock_plot.pdf", width = 16, height = 4) 
par(mfrow = c(1, 4))
for (i in 1:4) {
  plot(Fit.susc.par, trans=plogis, select = i)
}
dev.off()
...
legend("topleft", legend=legend_labels, pch=19, col="red", pt.cex=0.4, cex=0.58, bty="n", text.font=2)
